...
//   $current_time = date("H:i A", strtotime("9:30"));   //  CD  MM
//   $current_time = date("H:i A", strtotime("10:00"));  //  A CD  MM
//   $current_time = date("H:i A", strtotime("10:30"));  //  A CD  MM
//   $current_time = date("H:i A", strtotime("11:00"));  //  A CD  MM
//   $current_time = date("H:i A", strtotime("11:30"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("12:00"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("12:30"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("13:00"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("13:30"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("14:00"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("14:30"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("15:00"));  //  A CD  MM  CP  VM
//   $current_time = date("H:i A", strtotime("15:30"));  //  A CD  CP  VM
//   $current_time = date("H:i A", strtotime("16:00"));  //  A CD  CP  VM
//   $current_time = date("H:i A", strtotime("16:30"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("17:00"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("17:30"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("18:00"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("18:30"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("19:00"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("19:30"));  //  CD  CP  VM
//   $current_time = date("H:i A", strtotime("20:00"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("20:30"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("21:00"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("21:30"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("22:00"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("22:30"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("23:00"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("23:30"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("24:00"));  //  everything closed
//
// $today = "Sunday";                                    //WHAT SHOULD BE OPEN:

//   $current_time = date("H:i A", strtotime("4:00"));   //  everything closed
//   $current_time = date("H:i A", strtotime("7:00"));   //  everything closed
//   $current_time = date("H:i A", strtotime("7:30"));   //  CD
//   $current_time = date("H:i A", strtotime("8:00"));   //  CD
//   $current_time = date("H:i A", strtotime("8:30"));   //  CD
//   $current_time = date("H:i A", strtotime("9:00"));   //  CD  MM
//   $current_time = date("H:i A", strtotime("9:30"));   //  CD  MM
//   $current_time = date("H:i A", strtotime("10:00"));  //  B  CD MM
//   $current_time = date("H:i A", strtotime("10:30"));  //  B  CD MM
//   $current_time = date("H:i A", strtotime("11:00"));  //  B  CD MM
//   $current_time = date("H:i A", strtotime("11:30"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("12:00"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("12:30"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("13:00"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("13:30"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("14:00"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("14:30"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("15:00"));  //  B  CD MM  CP  VM
//   $current_time = date("H:i A", strtotime("15:30"));  //  B  CD  CP  VM
//   $current_time = date("H:i A", strtotime("16:00"));  //  B  CD  CP  VM
//   $current_time = date("H:i A", strtotime("16:30"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("17:00"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("17:30"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("18:00"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("18:30"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("19:00"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("19:30"));  //  B  CD  CP  VM  VG
//   $current_time = date("H:i A", strtotime("20:00"));  //  B  CP  VM
//   $current_time = date("H:i A", strtotime("20:30"));  //  B  CP  VM
//   $current_time = date("H:i A", strtotime("21:00"));  //  B  CP  VM
//   $current_time = date("H:i A", strtotime("21:30"));  //  CP  VM
  // $current_time = date("H:i A", strtotime("22:00"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("22:30"));  //  CP  VM
//   $current_time = date("H:i A", strtotime("23:00"));  //  CP  VM
